...
from core.exception.base import AppBaseException
from core.init.init_service import init_service
...
class BootStrap:
    ...
    def _init_exception(self):
        ...
        """
        self.application.add_exception_handler(AppBaseException, handlers.automate_exception_handler)
